...
!
    ...
    ELSE IF ( State_Grid%NZ == 26 ) THEN
       ...
       ! Ap [Pa] for 26 levels (27 edges) (note: TOA = L1 here)
       AP = (/    219.4067,  489.5209,   988.2418,   1805.201,        &
       ...
       ! Bp [unitless] for 26 levels (27 edges) (note: TOA = L1 here)
       BP = (/    0.,         0.,         0.,         0.,             &
                  0.,         0.,         0.,         0.,             &
       ...
       ! Reverse AP & BP to match GEOS-Chem convention
       AP = AP( State_Grid%NZ+1:1:-1 )
       BP = BP( State_Grid%NZ+1:1:-1 )
